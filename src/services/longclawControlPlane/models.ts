...
const SignalsAIFactorSchema = z.object({
  ...
  research_mode: z.string().default('research_first'),
  factor_origin: z.string().default('industry_research'),
  factor_family: JsonRecordSchema.default({}),
  industry_beta: JsonRecordSchema.default({}),
  expectation_alpha: JsonRecordSchema.default({}),
  technical_confirmation: JsonRecordSchema.default({}),
  strategy_integration: JsonRecordSchema.default({}),
  factor_exposures: JsonRecordSchema.default({}),
  validation_profile: JsonRecordSchema.default({}),
  ...
  validation: JsonRecordSchema.default({}),
  ...
  risk_overlay_flags: z.array(z.string()).default([]),
}).passthrough()
...
const SignalsAIFactorFactorySchema = z.object({
  ...
  phases: z.array(JsonRecordSchema).default([]),
  research_modes: JsonRecordSchema.default({}),
  factor_registry: JsonRecordSchema.default({}),
  candidate_factor_ideas: z.array(SignalsAIFactorSchema).default([]),
  factor_idea_queue: z.array(SignalsAIFactorSchema).default([]),
  ideas: z.array(SignalsAIFactorSchema).default([]),
